...
impl Workflows {
    ...
    pub fn add_workflow(new_name: &str) -> anyhow::Result<WorkflowMeta> {
    ...
    pub fn load_workflows() -> anyhow::Result<Vec<WorkflowMeta>> {
        let workflows_dir = Self::workflows_dir()?;
    ...
    pub fn load_workflow_from_path(path: impl AsRef<Path>) -> anyhow::Result<WorkflowMeta> {
        ...
        let workflow_factory = WorkflowMeta {
            id: workflow_id,
